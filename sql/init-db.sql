...
insert into users(userName, password, real_name, date_of_birth, description, avatar)
VALUES ('batman', '$2b$10$Ypucv4/TVNnArWcLYwfEPe.EMiOtspL9g10eb645neaZaHGf6t0ji', 'Bruce Wayne', '19-02-1985',
        ...
        'avatar15'),
       ('captain_america', '$2b$10$Ypucv4/TVNnArWcLYwfEPe.EMiOtspL9g10eb645neaZaHGf6t0ji', 'Steve Rogers', '04-07-1918',
        ...
        'avatar14'),
       ('iron_man', '$2b$10$Ypucv4/TVNnArWcLYwfEPe.EMiOtspL9g10eb645neaZaHGf6t0ji', 'Tony Stark', '29-05-1985',
...
insert into articles(articleId, title, date, content, author_name)
...
insert into comments(commentId, date, content, articleId, commenter_name)
VALUES (2001, default, 'Why can''t you give a secret to a pig? Because it might squeal.', 1001, 'iron_man'),
       (2002, default, 'I have a joke about construction, but I''m still working on it.', 1002, 'iron_man'),
       (2003, default, 'I told my wife she should embrace her mistakes. She gave me a hug.', 1003, 'batman'),
       (2004, default, 'Why don''t scientists trust atoms? Because they make up everything.', 1002, 'captain_america');
...
insert into likes(articleId, username)
VALUES (1002,'captain_america'),
       (1003,'captain_america'),
       (1001,'batman'),
       (1001,'iron_man');